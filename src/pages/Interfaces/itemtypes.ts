...
export interface ItemType { marketGroup: MarketGroup; type: Type; id: number; id_str: string; Jitaprice: number;
  Rensprice: number; Alertprice: number; AlertCondition: string }
